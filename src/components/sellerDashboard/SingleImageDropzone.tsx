  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        'border border-gray-400 text-gray-400 shadow hover:bg-gray-100 hover:text-muted-foreground dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700',
        // size
