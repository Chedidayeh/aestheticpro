...
<>
      ...
      <div className="mt-4 space-y-4 sm:space-y-0 sm:flex sm:space-x-4">
        ...
        <div className="w-full sm:w-1/2">
          ...
          <Input
            className="w-full mt-1"
            type="number"
            placeholder={t('max_per_request_week')}
      ...
      <div className="flex items-center justify-center my-6">
        <Button disabled={!isFormValid} onClick={handleRequest} size={"sm"} className='text-white'>{t('request_payment_button')}</Button>
      </div>
