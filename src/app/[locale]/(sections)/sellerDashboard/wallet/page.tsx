...
const Page =  async () => {
  const t = await  getTranslations('SellerWalletPage');
...
<h1 className="text-2xl font-semibold mb-8">{t('wallet_title')}</h1>
