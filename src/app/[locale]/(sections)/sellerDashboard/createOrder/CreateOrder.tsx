...
const CreateOrder = ({
  ...
  platform
        ...
        const t = useTranslations('SellerCreateOrderPage');
        ...
        const handleProductClick = () => {
            toast({
              title: t('toast_category_unavailable'),
              variant: "destructive",
            });
            return;
                ...
                const handleCatClick = async (index: number, product: Product) => {
                  ...
                  const handlePhoneNumberBlur = () => {
                    if (phoneNumber.length !== 8) {
                      setPhoneNumberError(t('phone_number_error'));
                    } else {
                      setPhoneNumberError('');
                    }
                  };
...
<Card className="col-span-full" x-chunk="dashboard-01-chunk-4">
  ...
  <p className="text-muted-foreground text-sm mt-4">
    <span className="text-blue-600 font-medium">{t('guide')}</span> {t('guide_select_product')}
  </p>
