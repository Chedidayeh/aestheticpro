...
export default function Page() {
    ...
    const t = useTranslations('AffiliateSettingsPage');
                            ...
                            {selectedSection === "delete" && (
                                <Card x-chunk="dashboard-04-chunk-1">
                                    ...
                                    <CardFooter className="border-t px-6 py-4">
                                        <Button onClick={handleAffiliateAccountDelete} className="bg-red-500 text-white hover:bg-red-400" >{t('deleteButton')}</Button>
                                    </CardFooter>
                                </Card>
                            )}
