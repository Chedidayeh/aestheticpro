        ...
        <>
          ...
          <div className="flex flex-col mb-4 mt-4 mx-4">
            ...
            <div className="mt-3 text-muted-foreground text-sm">
              {t('total_designs_found', {count: filteredAndSortedDesigns.length})}
            </div>
            ...
            <Link href={'/MarketPlace/create-client-product/select-category'}>
                  <Button size={"sm"} className="text-white" variant={"default"}>{t('try_designs')}</Button>
              </Link>  
          </div>
          </div>
                  </div>
          ...
          <h3 className='font-semibold text-2xl'>
            {t('designs_empty_title')}
          </h3>
          <p className='text-muted-foreground text-center'>
            {t('designs_empty_desc')}
          </p>
        </div>
