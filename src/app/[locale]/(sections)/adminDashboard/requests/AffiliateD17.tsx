  ...
  {paymentRequests.length > 0 ? (
      ...
      <ScrollArea
        ...
        >         
         <TableHeader>
          <TableRow>
            <TableHead>{t('card_holder')}</TableHead>
            <TableHead>{t('card_phone_number')}</TableHead>
        ...
        <TableBody>
          {paymentRequests.map((request , index) => (
            ...
            >
              <TableCell> {request.cardHolder || t('na')}</TableCell>
              <TableCell>{request.cardPhoneNumber || t('na')}</TableCell>
...
<p className="text-center text-xs mt-2">{t('new_d17_requests_appear')}</p>
      ...
      <Card className="col-span-full my-4" x-chunk="dashboard-01-chunk-4">
          <CardHeader className="flex flex-col md:flex-row items-center">
             ...
             <div>
                         ...
                         <div>
                             <p className="font-bold">{t('user_email')}</p>
